...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ReadTreeData(TTree *tree);

   virtual ~ReadTreeData();
   bool BaseLine();
...

{
 ...
 ReadTreeData::ReadTreeData(TTree *tree)
...
bool ReadTreeData::BaseLine(){//baseline
...
bool ReadTreeData::AllcutsDataMC(){//All cuts





if(NJets >=4  && HT > 500. && MHT >200. && dPhi1>0.5 && dPhi2>0.5 && dPhi3 > 0.3  && SigmaIetaIeta <0.0107 && IchSR==1){
